...
cl = YUDA.LINE()
cl.login(token='ElPJ2FgdOAsd6oQ18ta1.1+3Vi14Oeqtv+NdgJM0yKq.qImrsAAdMl+PP0AFvF9D38fKS/l3v2jOodHg5FuNfKw=')
cl.loginResult()
...
wait = {
    ...
    "lang":"JP",
    "comment":"Terimakasih telah Menambahkan Yuda",
    "commentOn":False,
    "commentBlack":{},
    "wblack":True,
    "dblack":True,
...
def bot(op):
    try:
        ...
        if op.type == 26:
            ...
            if msg.contentType == 13:
               if wait["wblack"] == True:
            ...
            elif ("Yuda gn " in msg.text):
                if msg.toType == 2:
                    X = cl.getGroup(msg.to)
                    X.name = msg.text.replace("Yuda gn ","")
                    ki.updateGroup(X)
                else:
                    ki.sendText(msg.to,"It can't be used besides the group.")
            elif ("Y2 gn " in msg.text):
                if msg.toType == 2:
                    X = cl.getGroup(msg.to)
                    X.name = msg.text.replace("Y2 gn ","")
                    kk.updateGroup(X)
                else:
                    kk.sendText(msg.to,"It can't be used besides the group.")
            elif ("y3 gn " in msg.text):
                if msg.toType == 2:
                    X = cl.getGroup(msg.to)
                    X.name = msg.text.replace("y3 gn ","")
                    kc.updateGroup(X)
                else:
            ...
            elif "yuda invite " in msg.text:
                midd = msg.text.replace("yuda invite ","")
                ...
                cl.sendMessage(msg)
            elif msg.text in ["yuda1"]:
                msg.contentType = 13
                msg.contentMetadata = {'mid': Amid}
                ki.sendMessage(msg)
            elif msg.text in ["yuda"]:
                msg.contentType = 13
                ...
                msg.text = None
                cl.sendMessage(msg)
            elif msg.text in ["æ„›ã®ãƒ—ãƒ¬ã‚¼ãƒ³ãƒˆ","Yuda1 gift"]:
                msg.contentType = 9
                msg.contentMetadata={'PRDID': 'a0768339-c2d3-4189-9653-2909e9bb6f58',
                                    'PRDTYPE': 'THEME',
                                    'MSGTPL': '6'}
                msg.text = None
                ki.sendMessage(msg)
            elif msg.text in ["æ„›ã®ãƒ—ãƒ¬ã‚¼ãƒ³ãƒˆ","Yuda2 gift"]:
                msg.contentType = 9
                msg.contentMetadata={'PRDID': 'a0768339-c2d3-4189-9653-2909e9bb6f58',
                                    'PRDTYPE': 'THEME',
                                    'MSGTPL': '8'}
                msg.text = None
                kk.sendMessage(msg)
            elif msg.text in ["æ„›ã®ãƒ—ãƒ¬ã‚¼ãƒ³ãƒˆ","Yuda3 gift"]:
                msg.contentType = 9
                msg.contentMetadata={'PRDID': 'a0768339-c2d3-4189-9653-2909e9bb6f58',
                                    'PRDTYPE': 'THEME',
                                    'MSGTPL': '10'}
                ...
                if msg.toType == 2:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"Not for use less than group")
            elif msg.text in ["Yuda1 ourl","y link on"]:
                if msg.toType == 2:
                    X = cl.getGroup(msg.to)
                    X.preventJoinByTicket = False
                    ki.updateGroup(X)
                    if wait["lang"] == "JP":
                        ki.sendText(msg.to,"Done selesai bos yuda")
                    else:
                ...
                if msg.toType == 2:
                    ...
                    kk.updateGroup(X)
                    if wait["lang"] == "JP":
                        kk.sendText(msg.to,"Done bisa yuda")
                    else:
		...
		for ticket_id in n_links:
			if wait["atjointicket"] == True:
                ...
                if wait["clock"] == True:
                    ...
                    profile = cl.getProfile()
                    profile.displayName = wait["bName"] + nowT
                    cl.updateProfile(profile)
                    cl.sendText(msg.to,"done")
                ...
                if wait["clock"] == True:
                    ...
                    cl.sendText(msg.to, "liat siders pencet $read")
                    try:
                       ...
                       if targets == []:
                           ...
                           for target in targets:
                                try:
                                    ...
                                    ki.sendText(msg.to,"Succes yudabot")
                                    kk.sendText(msg.to,"Fuck You")
                ...
                if msg.from_ in admin:
                    ...
                    for g in gs.members:
                        if _nametarget == g.displayName:
                            targets.append(g.mid)
                    if targets == []:
                        ki.sendText(msg.to,"Not found yuda")
                        kk.sendText(msg.to,"Not found yuda")
                        kc.sendText(msg.to,"Not found yuda")
                    else:
                        for target in targets:
                            try:
                                wait["blacklist"][target] = True
                                f=codecs.open('st2__b.json','w','utf-8')
                                json.dump(wait["blacklist"], f, sort_keys=True, indent=4,ensure_ascii=False)
                                cl.sendText(msg.to,"Succes yudabot")                                                             
                            except:
                                ki.sendText(msg.to,"Error")
                ...
                if msg.from_ in admin:
                    ...
                    for g in gs.members:
                        if _nametarget == g.displayName:
                            targets.append(g.mid)
                    if targets == []:
                        ki.sendText(msg.to,"tidak ada yud")
                    else:
                        for target in targets:
                            try:
                                ...
                                f=codecs.open('st2__b.json','w','utf-8')
                                json.dump(wait["blacklist"], f, sort_keys=True, indent=4,ensure_ascii=False)
                                cl.sendText(msg.to,"Succes yud")
                            except:
                                ki.sendText(msg.to,"Succes yud")
#-----------------------------------------------
            elif msg.text in ["Test"]:
                ki.sendText(msg.to,"Ok yud 􀨁􀄻double thumbs up􏿿")
#-------------------------------------------
...
#-----------------------------------------------
            ...
            elif msg.text in ["yud say hi"]:
                ki.sendText(msg.to,"Hi buddy 􀜁􀅔Doctor􏿿")

#-----------------------------------------------

            elif msg.text in ["yud say hinata pekok"]:
                ki.sendText(msg.to,"Hinata pekok 􀜁􀅔Har Har􏿿")
            elif msg.text in ["yud say didik pekok"]:
                ki.sendText(msg.to,"Didik pekok 􀜁􀅔Har Har􏿿")
            elif msg.text in ["yud say bobo ah","Bobo dulu ah"]:
                ki.sendText(msg.to,"Have a nice dream yud 􀜁􀅔Har Har􏿿")
            elif msg.text in ["yud say chomel pekok"]:
                ki.sendText(msg.to,"Chomel pekok 􀜁􀅔Har Har􏿿")
            elif msg.text in ["#welcome"]:
                ki.sendText(msg.to,"Selamat datang di yuda Family Room")
                kk.sendText(msg.to,"Jangan nakal ok! subscribe YouTube.com/YudaTheGoldMine")
#-----------------------------------------------
...
#-----------------------------------------------
            ...
            elif msg.text in ["Sp","Speed","kecepatan"]:
                start = time.time()
                cl.sendText(msg.to, "tunggu coy:v")
                elapsed_time = time.time() - start
                cl.sendText(msg.to, "0%s/detik" % (elapsed_time))
...
#------------------------------------------------------------------
                ...
                if wait["blacklist"] == {}:
                    ...
                    cl.sendText(msg.to,"yang kena Blacklist")
                    mc = ""
                ...
                if msg.toType == 2:
                    ...
                    for tag in wait["blacklist"]:
                        matched_list+=filter(lambda str: str == tag, gMembMids)
                    if matched_list == []:
                        cl.sendText(msg.to,"dia tidak kena blacklist")
                        return
                    for jj in matched_list:
                        cl.kickoutFromGroup(msg.to,[jj])
                    cl.sendText(msg.to,"Blacklist ane usir lu wkwkwk:v")
                ...
                if msg.from_ in admin:
                    ...
                    try:
                        ...
                        cl.sendText(msg.to,"Error")
            elif "Buat Album" in msg.text:
                try:
                    albumtags = msg.text.replace("Buat Album","")
                    gid = albumtags[:6]
